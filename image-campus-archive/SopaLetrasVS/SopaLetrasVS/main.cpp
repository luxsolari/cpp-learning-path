		...
		do
		{
			...
			if (cin.good() && (inputDimension > 0 && inputDimension < 4))
			{
				...
				case 1:
					...
					palabrasTotales = static_cast<int>(CantidadPalabras::POCAS);
					break;
				case 2:
					dimensionGrilla = static_cast<int>(DimensionGrilla::MEDIANO);
					palabrasTotales = static_cast<int>(CantidadPalabras::MAS_O_MENOS);
					break;
				case 3:
					dimensionGrilla = static_cast<int>(DimensionGrilla::GRANDE);
					palabrasTotales = static_cast<int>(CantidadPalabras::MUCHAS);
					break;
				default:
					break;
				}
